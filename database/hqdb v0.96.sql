...
--
-- Host: localhost
-- Generation Time: Nov 30, 2012 at 03:14 PM
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `image` varchar(100) NOT NULL DEFAULT '/images/noimage.jpeg',
  PRIMARY KEY (`barcode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Money Clip', 'Breakfast Foods', 11521340, 21.8, '3315', '/images/noimage.jpeg'),
('4 ink colour ball pen', 'Tobacco Papers', 11760294, 82.4, '4715', '/images/noimage.jpeg'),
('Duffle cooler bag', 'Toys & Games', 12008016, 32.05, '1975', '/images/noimage.jpeg'),
('Silver Round Zipper Tin', 'Gourmet Food', 13523279, 85.5, '2905', '/images/noimage.jpeg'),
('ASSORTED COLOUR JELLY BEANS IN SCREW CAP JAR', 'Automotive', 15521955, 95.45, '3680', '/images/noimage.jpeg'),
('ANTI STRESS SOCCER BALL', 'Bakery', 16543556, 3.45, '4740', '/images/noimage.jpeg'),
('Non-woven shopper bag', 'Tools, Auto & Industrial', 16686549, 97.25, '4545', '/images/noimage.jpeg'),
('Tape measure w/ carabiner hook.', 'Athletic & Outdoor Clothing', 16948044, 34.25, '590', '/images/noimage.jpeg'),
('Bath Salts Bottle', 'Video On Demand', 18121244, 41.5, '4775', '/images/noimage.jpeg'),
('Standard 12 inch (30cm) Balloons', 'Video Games', 18164847, 79.3, '2560', '/images/noimage.jpeg'),
('Rectangular Keyring', 'MP3 Downloads', 18175970, 85.05, '1380', '/images/noimage.jpeg'),
('Highlighter pen with memo pad', 'Grocery, Health & Beauty', 18243337, 60.05, '5385', '/images/noimage.jpeg'),
('Sports Towel', 'Hair Removal', 19619262, 86.65, '4340', '/images/noimage.jpeg'),
('Cotton Hatbands', 'Cell Phones & Service', 20151308, 20.65, '1980', '/images/noimage.jpeg'),
('Techno Flash Drive 256MB', 'Bottle', 20219909, 42.5, '4410', '/images/noimage.jpeg'),
('Ladies Aston Short Sleeve', 'Printers & Ink', 20909394, 27.95, '4540', '/images/noimage.jpeg'),
('A4 Portfolio', 'Video Games for Kids', 21884433, 22.85, '1050', '/images/noimage.jpeg'),
('Wired Backpack', 'Home & Garden', 22016225, 55.8, '4930', '/images/noimage.jpeg'),
('Trend Wine Cooler', 'Industrial & Scientific', 23946308, 94, '2035', '/images/noimage.jpeg'),
('Travel Clock', 'MP3 & Media Players', 24067314, 90.85, '5085', '/images/noimage.jpeg'),
('CONTOUR BALLPOINT PEN ', 'Outdoor Power Equipment', 24768324, 10.4, '1695', '/images/noimage.jpeg'),
('White paper shopping bag ', 'Team Sports', 26264360, 45.7, '4520', '/images/noimage.jpeg'),
('Whistle Keyring', 'Accessories', 26653184, 29.2, '1865', '/images/noimage.jpeg'),
('Blue ink ball pen ', 'Nursery', 27693372, 65.4, '5155', '/images/noimage.jpeg'),
('Acrylic Beanie ', 'Guinness', 28127291, 86.4, '2515', '/images/noimage.jpeg'),
('New Orleans Mug', 'Kindle DX', 28323264, 44.9, '5360', '/images/noimage.jpeg'),
('Urban Sticky Note Holder', 'Training Pants', 28366167, 98.05, '815', '/images/noimage.jpeg'),
('Goggles', 'Outdoor Recreation', 30011470, 31.55, '1300', '/images/noimage.jpeg'),
('Mesh Sports Cap', 'Shower & Bath Products', 30300675, 51.5, '5300', '/images/noimage.jpeg'),
('5 Panel Trucker Mesh Cap', 'Drinks', 30364600, 70.15, '2275', '/images/noimage.jpeg'),
