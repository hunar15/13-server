...
--
-- Host: localhost
-- Generation Time: Nov 12, 2012 at 11:32 AM
...
(1, 1111, 111, 122, 40, 'NORMAL'),
(1, 11521340, 3315, 21.8, 2415, 'NORMAL'),
(1, 11760294, 4715, 82.4, 3065, 'NORMAL'),
(1, 12008016, 1975, 32.05, 100, 'NORMAL'),
(1, 13523279, 2905, 85.5, 100, 'NORMAL'),
(1, 15521955, 3680, 95.45, 1180, 'NORMAL'),
(1, 16543556, 4740, 3.45, 3840, 'NORMAL'),
(1, 16686549, 4545, 97.25, 3845, 'NORMAL'),
(1, 16948044, 590, 34.25, 100, 'NORMAL'),
(1, 18121244, 4775, 41.5, 2925, 'NORMAL'),
(1, 18164847, 2560, 79.3, 160, 'NORMAL'),
(1, 18175970, 1380, 85.05, 100, 'NORMAL'),
(1, 18243337, 5385, 60.05, 2035, 'NORMAL'),
(1, 19619262, 4340, 86.65, 890, 'NORMAL'),
(1, 20151308, 1980, 20.65, 380, 'NORMAL'),
(1, 20219909, 4410, 42.5, 3660, 'NORMAL'),
(1, 20909394, 4540, 27.95, 1690, 'NORMAL'),
(1, 21884433, 1050, 22.85, 100, 'NORMAL'),
(1, 22016225, 4930, 55.8, 4230, 'NORMAL'),
(1, 23946308, 2035, 94, 1785, 'NORMAL'),
(1, 24067314, 5085, 90.85, 1885, 'NORMAL'),
(1, 24768324, 1695, 10.4, 100, 'NORMAL'),
(1, 26264360, 4520, 45.7, 2370, 'NORMAL'),
(1, 26653184, 1865, 29.2, 100, 'NORMAL'),
(1, 27693372, 5155, 65.4, 4755, 'NORMAL'),
(1, 28127291, 2515, 86.4, 1565, 'NORMAL'),
(1, 28323264, 5360, 44.9, 3510, 'NORMAL'),
(1, 28366167, 815, 98.05, 100, 'NORMAL'),
(1, 30011470, 1300, 31.55, 100, 'NORMAL'),
(1, 30300675, 5300, 51.5, 4400, 'NORMAL'),
(1, 30364600, 2275, 70.15, 1275, 'NORMAL'),
(1, 31129261, 1295, 71.65, 100, 'NORMAL'),
(1, 31555897, 820, 61, 100, 'NORMAL'),
(1, 32592458, 5335, 97.35, 4435, 'NORMAL'),
(1, 32703379, 3665, 53.15, 100, 'NORMAL'),
(1, 33188933, 1215, 40.85, 100, 'NORMAL'),
(1, 33464262, 3300, 85.25, 100, 'NORMAL'),
(1, 33491310, 575, 37.85, 100, 'NORMAL'),
(1, 34571368, 4640, 78.3, 2690, 'NORMAL'),
(1, 34994031, 1390, 51.4, 100, 'NORMAL'),
(1, 35412528, 4350, 56.65, 100, 'NORMAL'),
(1, 35653240, 2310, 68.4, 100, 'NORMAL'),
(1, 35760875, 2610, 14.45, 100, 'NORMAL'),
(1, 36002736, 4310, 24.05, 100, 'NORMAL'),
(1, 36092718, 4015, 56.6, 2815, 'NORMAL'),
(1, 36795157, 3225, 80.6, 1675, 'NORMAL'),
(1, 37676915, 4835, 78.95, 2135, 'NORMAL'),
(1, 38004786, 5410, 90.15, 3010, 'NORMAL'),
(1, 40098529, 4490, 83.45, 990, 'NORMAL'),
(1, 40155785, 1990, 41.8, 1290, 'NORMAL'),
(1, 40443390, 3425, 33.85, 100, 'NORMAL'),
(1, 40924160, 1525, 45.6, 100, 'NORMAL'),
(1, 41660339, 2430, 30.2, 100, 'NORMAL'),
(1, 43741253, 5155, 30, 4405, 'NORMAL'),
(1, 46547386, 4920, 82.65, 4370, 'NORMAL'),
(1, 47974430, 4895, 35.4, 4045, 'NORMAL'),
(1, 50148962, 1495, 46.35, 895, 'NORMAL'),
(1, 51312536, 5200, 40.35, 1350, 'NORMAL'),
(1, 51336619, 3195, 36.05, 1895, 'NORMAL'),
(1, 51808477, 2810, 47.1, 1710, 'NORMAL'),
(1, 52240015, 4930, 1.25, 680, 'NORMAL'),
(1, 54053173, 655, 37.9, 100, 'NORMAL'),
(1, 54528680, 4065, 83.5, 2465, 'NORMAL'),
(1, 55659812, 1740, 46.3, 100, 'NORMAL'),
(1, 56208845, 1220, 96.3, 100, 'NORMAL'),
(1, 59030623, 3325, 26.85, 2625, 'NORMAL'),
(1, 61187597, 3605, 9.95, 3155, 'NORMAL'),
(1, 63502056, 965, 74.8, 100, 'NORMAL'),
(1, 64677697, 865, 4.75, 100, 'NORMAL'),
(1, 65201080, 2200, 92.5, 1250, 'NORMAL'),
(1, 65871735, 4460, 71.25, 760, 'NORMAL'),
(1, 66752080, 3315, 93.8, 1215, 'NORMAL'),
(1, 66765410, 920, 18.4, 220, 'NORMAL'),
(1, 67531375, 890, 21.15, 100, 'NORMAL'),
(1, 67775131, 3705, 82.9, 100, 'NORMAL'),
(1, 67859788, 5350, 14.45, 2800, 'NORMAL'),
(1, 68508930, 1460, 65.3, 100, 'NORMAL'),
(1, 69693583, 3355, 57.6, 3205, 'NORMAL'),
(1, 70525778, 1820, 87.45, 100, 'NORMAL'),
(1, 75506105, 2580, 66.65, 100, 'NORMAL'),
(1, 76409993, 1910, 96.15, 1010, 'NORMAL'),
(1, 77464010, 3330, 86.25, 780, 'NORMAL'),
(1, 78107011, 560, 52.25, 100, 'NORMAL'),
(1, 79951082, 4295, 7.55, 100, 'NORMAL'),
(1, 80796672, 1835, 80.6, 100, 'NORMAL'),
(1, 81856054, 1965, 19.7, 815, 'NORMAL'),
(1, 81889450, 1660, 64.85, 100, 'NORMAL'),
(1, 82129140, 2840, 36.75, 100, 'NORMAL'),
(1, 83024065, 1595, 63.2, 295, 'NORMAL'),
(1, 83829674, 4470, 71.25, 4020, 'NORMAL'),
(1, 83920592, 2540, 65.7, 100, 'NORMAL'),
(1, 86377180, 4020, 18.15, 2670, 'NORMAL'),
(1, 86747844, 3895, 38.3, 2645, 'NORMAL'),
(1, 88491799, 1205, 94.35, 655, 'NORMAL'),
(1, 88723081, 2925, 4.15, 100, 'NORMAL'),
(1, 90114604, 2905, 2.75, 100, 'NORMAL'),
(1, 90359597, 850, 85.45, 100, 'NORMAL'),
(1, 90713781, 4400, 90.65, 3850, 'NORMAL'),
(1, 91000270, 2290, 66.45, 2140, 'NORMAL'),
(1, 93404773, 2050, 6.2, 100, 'NORMAL'),
(1, 93719528, 3130, 23.05, 830, 'NORMAL');
...
ALTER TABLE `inventory`
  ...
  ADD CONSTRAINT `inventory_ibfk_1` FOREIGN KEY (`outlet_id`) REFERENCES `outlet` (`id`);

--
-- Constraints for table `request_details`
--
ALTER TABLE `request_details`
  ADD CONSTRAINT `request_details_ibfk_3` FOREIGN KEY (`outlet_id`) REFERENCES `batch_request` (`outlet_id`),
